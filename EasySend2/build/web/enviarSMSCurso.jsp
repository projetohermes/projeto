...
<html>
    ...
    <body>
        ...
        <h2>Enviar SMS para Cursos</h2>

        <%
            String mensagem = request.getParameter("mensagem");
                   %>

        <form action="EasySendServlet?tarefa=enviarSMSCurso" method="POST">

            <label for="cursos">Cursos: </label><br /><br />
            <c:forEach var="curso" items ="${cursos}">            
                ${curso.nome} - ${curso.tipoCurso}<input type="checkbox" name="cursos" value="${curso.idCurso}"> <br />
            </c:forEach>
